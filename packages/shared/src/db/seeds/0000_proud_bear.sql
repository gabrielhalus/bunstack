...
INSERT INTO "roles" ("id", "name", "label", "description", "index", "is_default", "is_super_admin", "created_at", "updated_at") VALUES
(1, 'admin', 'Administrator', 'Full access and control.', 100, 0, 1, 1735686000, 1735686000),
(2, 'user', 'User', 'Basic access to the platform.', 0, 1, 0, 1735686000, 1735686000),
(3, 'moderator', 'Moderator', 'Can moderate user content.', 50, 0, 0, 1735686000, 1735686000);
--> statement-breakpoint
